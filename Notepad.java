...
public class Notepad extends KeyAdapter  implements ActionListener, KeyListener
{
    ...
    JMenuItem newdoc, opendoc, exit, savedoc, saveasdoc, copydoc,backgroundColor ,pastedoc, remdoc,fontfamily, fontstyle, fontsize, status;
    JTextArea maintext;
    JTextField title;
    Font font1;
//    JMenuItem color1,color2;
    ...
    JList familylist, stylelist, sizelist,backgroundlist;
    ...
    String ffamily, fsizestr, fstylestr,fcolor;
    int fstyle;
    int cl;
    int linecount;
    String tle ;
    ...
    Notepad(){
        ...
        backgroundlist=new JList(backgroundvalue);
        ...
        backgroundColor = new JMenuItem("Set Text color");
...
//    }
    public void actionPerformed(ActionEvent ae)
    {
        ...
        else if (ae.getSource()== backgroundColor)
        {
            ...
            JOptionPane.showConfirmDialog(null, backgroundlist, "Choose Text color", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
            fcolor=String.valueOf(backgroundlist.getSelectedValue());
            // or this is fram complete screen
